...
const STORAGE_KEY = "benim-miov-web-data-v5";
...
const CITY_VETS = {
  ...
  Izmir: [
    ...
    { id: 3, name: "Bornova Acil Hayvan", district: "Bornova", distance: "5.7 km", eta: "17 dk", address: "Kazımdirik Mah. 372 Sok.", phone: "0232 555 30 30" },
  ],
  Bursa: [
    { id: 1, name: "Nilüfer Vet House", district: "Nilüfer", distance: "1.7 km", eta: "8 dk", address: "FSM Bulvarı", phone: "0224 555 10 10" },
    { id: 2, name: "Osmangazi Hayvan Sağlık", district: "Osmangazi", distance: "4.5 km", eta: "14 dk", address: "Altıparmak Cad.", phone: "0224 555 20 20" },
  ],
  Antalya: [
    { id: 1, name: "Lara Pet Care", district: "Muratpaşa", distance: "1.4 km", eta: "6 dk", address: "Lara Cad. No:93", phone: "0242 555 10 10" },
    { id: 2, name: "Konyaaltı Vet Plus", district: "Konyaaltı", distance: "4.1 km", eta: "12 dk", address: "Akdeniz Bulvarı", phone: "0242 555 20 20" },
  ],
};
...
const INITIAL_ADOPTIONS = [
  {
    ...
    city: "Istanbul",
    note: "Oyuncu, kum eğitimi var, sakin bir eve uyum sağlar.",
    image: "https://cdn2.thecatapi.com/images/dbQ6j9zO8.jpg",
    owner: "Sena A.",
  },
  {
    id: 2,
    ...
    breed: "Scottish Fold",
    city: "Ankara",
    note: "Sessiz yapılı, düzenli veteriner kontrolleri yapıldı.",
    image: "https://cdn2.thecatapi.com/images/3btzAjRh1.jpg",
    owner: "Mert K.",
  },
];
...
export default function BenimMiovWebPreview() {
  ...
  const [vetCity, setVetCity] = useState("Istanbul");
  ...
  const [adoptionForm, setAdoptionForm] = useState({ name: "", breedId: "", breed: "", age: AGE_OPTIONS[3], city: "Istanbul", note: "", image: "", owner: "" });
    ...
    const loadBreeds = async () => {
      try {
        ...
        if (data.length > 0) {
          ...
          setAdoptionForm((prev) => ({ ...prev, breed: first.name, breedId: first.id, image: getBreedImage(first) }));
        }
      } catch {
        setBreedOptions([]);
      } finally {
  ...
  const vetResults = CITY_VETS[vetCity] || [];
  ...
  const handleAddAdoption = () => {
    ...
    setAdoptionForm({ name: "", breedId: breedOptions[0]?.id || "", breed: breedOptions[0]?.name || "", age: AGE_OPTIONS[3], city: "Istanbul", note: "", image: getBreedImage(breedOptions[0]) || "", owner: "" });
  };
...
const styles = {
  ...
  primaryButtonFull: { width: "100%", border: "none", background: "linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)", color: "#fff", padding: "14px 18px", borderRadius: 16, fontWeight: 800, fontSize: 15, cursor: "pointer" },
